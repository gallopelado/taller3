    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php //echo $usu->getBorrar()==""? "false": "true"; ?>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
                    ...
                    <div class="panel-body">
                      <div class="row">
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                          <button type="button" class="nuevo btn btn-primary btn-block" data-toggle="modal"  data-target="#myModal" id="btnNueva">
                            Nueva Ciudad
                          </button>
                        </div>
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
...
<script src="<?php echo DIR_RAIZ."recursos/js/ciudad.js" ?>"></script>
</body>
</html>
