...
<?php include PARTIALS_PATH . "menu.php" ?>
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Mantener Nacionalidad</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
                        ...
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                            ...
                            <div class="modal-header">
                              ...
                              <h4 class="modal-title">Gestionar Nacionalidad</h4>
                            </div>
                            <!-- Modal body -->
...
<script src="<?php echo DIR_RAIZ."recursos/js/nacionalidad.js" ?>"></script>
</body>
</html>
