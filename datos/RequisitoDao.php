...
include '../../entidades/Requisito.php';

class RequisitoDao extends Conexion {
  ...
  public static function getAll() {
    try {
      $query = "SELECT * FROM v_requisitos";
  ...
  public static function getAllSinCartas() {
    try {
      $query = "SELECT * FROM v_requisitos_sin_cartas";
