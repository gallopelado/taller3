...
function mostrarReporteTotal() {
    window.open("http://localhost/iec_copia/validaciones/reportes/afiliante/mostrarReporteTotal.php");
}
...
function generar() {
    if(validar()) {
        ...
        window.open(`http://localhost/iec_copia/validaciones/reportes/afiliante/mostrarReportePorFecha.php?txtinicio="${document.getElementById("txtFechaInicio").value}"&txtfin="${document.getElementById("txtFechaFin").value}"`);
    }
}
